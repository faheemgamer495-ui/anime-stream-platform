    ...
    >
      <div className="space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <div className="bg-card border border-white/10 rounded-xl p-3.5 md:p-4 hover:border-white/20 transition-colors">
            <div className="flex items-center gap-1.5 mb-2">
              <span className="w-2 h-2 rounded-full bg-amber-400" />
              <p className="text-[10px] text-white/40 font-medium">Pending</p>
            </div>
          ...
          <div className="bg-card border border-white/10 rounded-xl p-3.5 md:p-4 hover:border-white/20 transition-colors">
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <p className="text-[10px] text-white/40 font-medium">Completed</p>
            </div>
            <p className="text-2xl font-display font-black text-foreground">
              {completedRequests.length}
            </p>
            <p className="text-[10px] text-white/30 mt-0.5">fulfilled</p>
          </div>
          <div className="bg-card border border-white/10 rounded-xl p-3.5 md:p-4 hover:border-white/20 transition-colors col-span-2 sm:col-span-1">
            <div className="flex items-center gap-1.5 mb-2">
