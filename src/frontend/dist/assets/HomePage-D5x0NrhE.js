import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, L as Link, u as useFeaturedAnime, a as useLatestAnime, b as useTrendingAnime, d as usePopularAnime, e as useAnimeByGenre, f as useAllAnime, g as useAuth, H as HeroBannerSkeleton, G as GenreFilter, C as CarouselSkeleton, h as ue } from "./index-EgDyTYGb.js";
import { A as AnimeCard } from "./AnimeCard-DBV2hksL.js";
import { B as Badge } from "./badge-DoY1tOCt.js";
import { u as useEpisodesByAnime } from "./useEpisodes-Cn2KRf2A.js";
import { S as Star } from "./star-Dex4ctD4.js";
import { P as Play } from "./play-CBdCPXZ4.js";
import { C as Check } from "./check-CqKCVtSR.js";
import { P as Plus } from "./plus-CCOzFWtb.js";
import { I as Info } from "./info-D1zCW0Yo.js";
import { u as useAdsByPlacement } from "./useAds-BrDSk_pZ.js";
import { u as useWatchlist, a as useAddToWatchlist, b as useRemoveFromWatchlist } from "./useWatchlist-CqIoLCKD.js";
/**
...
function HomePage() {
  ...
  const showErrorBanner = !isContentLoading && allAnimeError !== null && allAnime.length === 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-16", "data-ocid": "homepage", children: [
    ...
    showErrorBanner && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-[#E50914]", children: [
              "Unable to load content —",
              " "
            ] }),
            "please refresh the page. If the problem persists, the server may be temporarily unavailable."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: isContentLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselSkeleton, { title: "Latest Anime" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselSkeleton, { title: "Trending Now" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselSkeleton, { title: "Popular Series" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
